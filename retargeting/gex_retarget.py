...
from .custom_constants import get_default_config_path, RobotName, RetargetingType, HandType, ROBOT_NAME_MAP_INV
...
class GexRetarget:
    def __init__(self):
        robot_name = ROBOT_NAME_MAP_INV['gx11']
    ...
    def retarget(self, finger_pos_list):
        ref_value = finger_pos_list[self.origin_indices, :] - finger_pos_list[self.task_indices, :]
